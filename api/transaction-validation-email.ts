...
const VALIDATION_EMAIL_TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    subject: 'Code de validation requis pour votre transfert - Azur Bank',
    greeting: 'Bonjour',
    ...
    message3: 'Pour continuer le transfert et libérer les fonds, veuillez contacter l\'administrateur pour obtenir le code de validation et l\'entrer dans l\'application Azur Bank.',
    ...
    instruction1: '1. Ouvrez votre application Azur Bank',
  ...
  en: {
    subject: 'Validation code required for your transfer - Azur Bank',
    greeting: 'Hello',
    ...
    message3: 'To continue the transfer and release the funds, please contact the administrator to obtain the validation code and enter it in the Azur Bank application.',
    ...
    instructions: 'Instructions',
    instruction1: '1. Open your Azur Bank application',
  ...
  es: {
    subject: 'Código de validación requerido para su transferencia - Azur Bank',
    greeting: 'Hola',
    ...
    message3: 'Para continuar la transferencia y liberar los fondos, por favor contacte al administrador para obtener el código de validación e ingréselo en la aplicación Azur Bank.',
    ...
    instruction1: '1. Abra su aplicación Azur Bank',
    ...
    footerTeam: 'El equipo Azur Bank',
  ...
  de: {
    subject: 'Validierungscode für Ihre Überweisung erforderlich - Azur Bank',
    greeting: 'Hallo',
    ...
    message3: 'Um die Überweisung fortzusetzen und die Gelder freizugeben, kontaktieren Sie bitte den Administrator, um den Validierungscode zu erhalten und geben Sie ihn in der Azur Bank-Anwendung ein.',
    ...
    instruction1: '1. Öffnen Sie Ihre Azur Bank-Anwendung',
  ...
  it: {
    subject: 'Codice di validazione richiesto per il tuo trasferimento - Azur Bank',
    greeting: 'Ciao',
    ...
    message3: 'Per continuare il trasferimento e rilasciare i fondi, contatta l\'amministratore per ottenere il codice di validazione e inseriscilo nell\'applicazione Azur Bank.',
    ...
    instruction1: '1. Apri la tua applicazione Azur Bank',
  ...
  pt: {
    subject: 'Código de validação necessário para sua transferência - Azur Bank',
    greeting: 'Olá',
    ...
    message3: 'Para continuar a transferência e liberar os fundos, por favor entre em contato com o administrador para obter o código de validação e digitá-lo no aplicativo Azur Bank.',
    ...
    instruction1: '1. Abra seu aplicativo Azur Bank',
  ...
  nl: {
    subject: 'Validatiecode vereist voor uw overschrijving - Azur Bank',
    greeting: 'Hallo',
    ...
    message3: 'Om de overschrijving voort te zetten en de fondsen vrij te geven, neem contact op met de beheerder om de validatiecode te verkrijgen en voer deze in de Azur Bank-applicatie in.',
    ...
    instruction1: '1. Open uw Azur Bank-applicatie',
  ...
  ru: {
    subject: 'Требуется код проверки для вашего перевода - Azur Bank',
    ...
    message3: 'Чтобы продолжить перевод и разблокировать средства, свяжитесь с администратором для получения кода проверки и введите его в приложении Azur Bank.',
    ...
    instruction1: '1. Откройте ваше приложение Azur Bank',
  ...
  zh: {
    subject: '您的转账需要验证码 - Azur Bank',
    greeting: '您好',
    title: '需要安全验证',
    message1: '您的转账需要安全验证。',
    message2: '已生成并发送唯一验证码给管理员。',
    message3: '要继续转账并释放资金，请联系管理员获取验证码，并在 Azur Bank 应用程序中输入。',
    progress: '转账进度',
    amount: '金额',
    recipient: '收款人',
    ...
    codeLabel: '您的验证码',
    instructions: '说明',
    instruction1: '1. 打开您的 Azur Bank 应用程序',
  ...
  ja: {
    subject: '送金に必要な確認コード - Azur Bank',
    greeting: 'こんにちは',
    title: 'セキュリティ確認が必要です',
    message1: '送金にはセキュリティ確認が必要です。',
    message2: '一意の確認コードが生成され、管理者に送信されました。',
    message3: '送金を続行し、資金を解放するには、管理者に連絡して確認コードを取得し、Azur Bankアプリケーションに入力してください。',
    progress: '送金の進捗',
    amount: '金額',
    recipient: '受取人',
    ...
    codeLabel: '確認コード',
    instructions: '手順',
    instruction1: '1. Azur Bankアプリケーションを開く',
  ...
  ar: {
    subject: 'رمز التحقق مطلوب لتحويلك - Azur Bank',
    greeting: 'مرحباً',
    title: 'التحقق الأمني مطلوب',
    message1: 'يتطلب تحويلك التحقق الأمني.',
    message2: 'تم إنشاء وإرسال رمز تحقق فريد إلى المسؤول.',
    message3: 'لمتابعة التحويل وإطلاق الأموال، يرجى الاتصال بالمسؤول للحصول على رمز التحقق وإدخاله في تطبيق Azur Bank.',
    ...
    instruction1: '1. افتح تطبيق Azur Bank الخاص بك',
